...
[![Go Reference](https://pkg.go.dev/badge/github.com/cplieger/web-terminal-engine/v4.svg)](https://pkg.go.dev/github.com/cplieger/web-terminal-engine/v4)
...
- Go: `go get github.com/cplieger/web-terminal-engine/v4@latest`
